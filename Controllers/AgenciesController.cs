...
namespace MVCRealEstate.Controllers
{
    public class AgenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AgencyId,Name,Email,Phones,Address,Logo,CanViewWishlist,Active,CreatedAt")] Agency agency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AgencyId,Name,Email,Phones,Address,Logo,CanViewWishlist,Active,CreatedAt")] Agency agency)
        {
